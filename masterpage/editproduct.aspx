<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editproduct.aspx.cs" Inherits="masterpage.editproduct" %>
                            ...
                            <asp:TemplateField HeaderText="update image">
                                <ItemTemplate>
                                    <table class="auto-style1">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Bind("product_photo") %>' />
                                            </td>
                                            <td>&nbsp;</td>
                                            <td class="auto-style3">&nbsp;</td>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image1" runat="server" Height="98px" ImageUrl='<%# Bind("product_photo") %>' />
                                            </td>
                                            <td>&nbsp;</td>
                                            <td class="auto-style3">&nbsp;</td>
                                            <td>&nbsp;</td>
